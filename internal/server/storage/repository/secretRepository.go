...
// ISecretRepository определяет интерфейс для репозитория секретов,
// предоставляющего методы для работы с секретами в базе данных.
...
func NewSecretRepository(db *sqlx.DB) ISecretRepository {
